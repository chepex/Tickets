...
import com.entities.Requerimiento;
import com.entities.RequerimientoFacade;
...
@FacesConverter(value = "requerimientoConverter")
public class RequerimientoConverter implements Converter {

    @Inject
    private RequerimientoFacade ejbFacade;
